    ...
    if (MPI_${lang}_COMPILER)
      ...
      if (MPI_COMPILER_RETURN EQUAL 0)
        ...
        if (MPI_COMPILER_RETURN EQUAL 0)
          ...
          set(MPI_IMPLEMENTATION "openmpi" PARENT_SCOPE)
          message(STATUS "Found openmpi for ${lang}")
          execute_process(
      ...
      if (NOT MPI_COMPILER_RETURN EQUAL 0)
        ...
        if (MPI_COMPILER_RETURN EQUAL 0)
          set(MPI_IMPLEMENTATION "lam" PARENT_SCOPE)
          message(STATUS "Found lam-mpi for ${lang}")
        endif()
      endif()
      ...
      if (NOT MPI_COMPILER_RETURN EQUAL 0)
        ...
        if (MPI_COMPILER_RETURN EQUAL 0)
           set(MPI_IMPLEMENTATION "mpich2" PARENT_SCOPE)
           message(STATUS "Found mpich2 for ${lang}")
        endif()
      endif()
